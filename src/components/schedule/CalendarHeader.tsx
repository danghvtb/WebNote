      ...
      <div className="flex items-center justify-between sm:justify-start gap-2 relative">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="hidden md:inline-block text-[11px] font-normal text-amber-400/90 bg-amber-500/10 px-2 py-0.5 rounded-lg border border-amber-500/20 ml-1">
              🌙 {formatLunarDateFull(selectedDate)}
            </span>
          </button>

          {/* Quick Date Picker Popover */}
          {datePickerOpen && (
            <div className="absolute left-0 top-11 z-[100] p-3 bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl space-y-2 animate-in fade-in zoom-in-95 duration-150 w-72 text-slate-100">
              ...
              <div className="pt-2 border-t border-slate-800/80 text-[11px] text-amber-300/90 bg-amber-500/10 p-2 rounded-xl border border-amber-500/20">
